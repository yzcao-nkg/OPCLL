...
def prepare_train_loaders(full_train_loader, batch_size, ordinary_train_dataset):
    ...
    ordinary_train_loader = torch.utils.data.DataLoader(ordinary_train_dataset, batch_size=batch_size, shuffle = True)

    complementary_train_loader = torch.utils.data.DataLoader(complementary_dataset, batch_size=batch_size, shuffle = True)
